<template>
	<div class="wrapper">
					...
					<div class="flex-8">
						<div v-if="storeAddress">
							<div class="user-address">
								...
								<div>
								    <span class="mobile">商家电话 {{ storeAddress.mobile }}</span>
								    <span class="storeDistance">距离您 {{ storeDistance }} km</span>
								</div>
		...
		<div class="box box2" v-for="(item, index) in orderMessage.cartList" :key="index">
            ...
            " :span="3">
						<u-image borderRadius="10rpx" width="200rpx" height="200rpx" :src="val.goodsSku.thumbnail"
							alt />
					</div>
					<div @click="
              navigateTo(
            ...
            " class="goods-detail">
				...
				<u-row>
					<u-col v-if="orderMessage.cartTypeEnum != 'VIRTUAL'" :offset="0" :span="9"
						@click="shippingFlag = true">选择配送方式
					</u-col>
...
<script>
	...
	export default {
		...
		async onShow() {
			...
			/**解决首次渲染页面时配送方式一直是物流的问题***/
			await this.getDistribution();
			await this.confirmDistribution(this.shippingMethod);
