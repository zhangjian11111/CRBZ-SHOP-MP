const name = "西部胜海牛肉面"; //全局商城name
const schemeName = '西部胜海牛肉面' //唤醒app需要的schemeName
export default {
  name: name,
  ...
  logo:"https://xbcdn.qgxbm.com/XBMALL/images/xblogo-nofont-color1-1.png", //logo地址
  ...
  defaultUserPhoto: "https://xbcdn.qgxbm.com/XBMALL/images/xblogo-nofont-color1-1.png", // 默认用户头像
